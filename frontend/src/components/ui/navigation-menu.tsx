...
function NavigationMenuLink({
    ...
    return (
        <NavigationMenuPrimitive.Link
            ...
            className={cn(
                "data-[active=true]:focus:bg-primary/20 data-[active=true]:focus:text-accent-foreground",
                "data-[active=true]:hover:bg-accent data-[active=true]:hover:text-accent-foreground",
                "data-[active=true]:bg-primary data-[active=true]:text-primary-foreground data-[active=true]:shadow-md data-[active=true]:shadow-primary/20",
                ...
                "flex flex-col gap-4.5 rounded-sm p-2 text-base transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 font-semibold",
                className,
            )}
            {...props}
        />
